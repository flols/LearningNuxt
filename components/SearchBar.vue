...
<template>
  <section class="search-section bg-cyan-50 py-4">
    <div class="container mx-auto md:px-40 px-5">
      <div class="flex">
        <input
          class="border border-cyan-400 py-2 px-4 w-full rounded-l-full focus:outline-none focus:ring-2 focus:ring-cyan-400"
          type="text"
